...
class JavaExtensionPublishingIntegrationSpec extends AbstractJavaPublishingIntegrationSpec {
    ...
    def 'Test default open-source release publishing'() {
        ...
        then:
        checkMavenRepo('0.1.1', new ArtifactConfig(publishTests: false, publishSources: false, publishJavaDoc: false, repo: 'releases'))
    }
    ...
    def 'Test default open-source snapshot publishing'() {
        ...
        then:
        checkMavenRepo('0.1.1-SNAPSHOT', new ArtifactConfig(publishTests: false, publishSources: false, publishJavaDoc: false, repo: 'snapshots'))
    }
